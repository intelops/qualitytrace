...
```bash
qualityTrace configure --token {ADD_YOUR_TOKEN_HERE}
```

One example of this usage can be seen [here](https://github.com/intelops/qualityTrace/blob/main/.github/workflows/scheduled-jobs.yml#L23).
