...
[Sign in to Tracetest](https://app.qualitytrace.io/) and follow the instructions on the `Settings > Access` page.

Select `Application is publicly accessible`.

![](https://res.cloudinary.com/djwdcmwdz/image/upload/v1712602150/docs/app.qualitytrace.io_organizations_ttorg_2179a9cd8ba8dfa5_environments_ttenv_597cf82c754c2a01_settings_2_bs2zc9.png)
