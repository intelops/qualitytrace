...
:::tip
Examples of configuring Tracetest with New Relic can be found in the [`examples` folder of the Tracetest GitHub repo](https://github.com/intelops/qualitytrace/tree/main/examples).
:::
...
service:
  pipelines:
    ...
    traces/qualitytrace:
      ...
      processors: [batch]
      exporters: [otlp/qualitytrace] # your exporter pointing to your qualitytrace instance
    traces/newrelic:
      receivers: [otlp] # your receiver
      processors: [batch]
...
:::tip
To learn more, [read the recipe on running a sample app with New Relic and Tracetest](/examples-tutorials/recipes/running-qualitytrace-with-new-relic).
:::
