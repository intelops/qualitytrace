...
:::tip
Examples of configuring Tracetest with X-Ray can be found in the [`examples` folder of the Tracetest GitHub repo](https://github.com/intelops/qualitytrace/tree/main/examples).
:::
...
:::tip
To learn more, [read the recipe on running a sample app with AWS X-Ray and Tracetest](/examples-tutorials/recipes/running-qualitytrace-with-aws-x-ray).
:::
