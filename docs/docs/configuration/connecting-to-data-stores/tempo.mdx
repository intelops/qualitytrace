...
:::tip
Examples of configuring Tracetest can be found in the [`examples` folder of the Tracetest GitHub repo](https://github.com/intelops/qualityTrace/tree/main/examples).
:::
...
![tempo grpc](https://res.cloudinary.com/djwdcmwdz/image/upload/v1710422510/docs/app.qualityTrace.io_organizations_ttorg_e66318ba6544b856_environments_ttenv_ad034a744607c050_settings_tab_agent_1_fc2ccz.png)
...
![Tempo http](https://res.cloudinary.com/djwdcmwdz/image/upload/v1710422502/docs/app.qualityTrace.io_organizations_ttorg_e66318ba6544b856_environments_ttenv_ad034a744607c050_settings_tab_agent_gqqnjy.png)
...
:::tip
To learn more, [read the recipe on running a sample app with Tempo and Tracetest](/examples-tutorials/recipes/running-qualityTrace-with-tempo).
:::
