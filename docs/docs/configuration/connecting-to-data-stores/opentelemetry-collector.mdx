...
```
http://your-qualityTrace-instance.com:4317
```
...
exporters:
  ...
  otlp/1:
    endpoint: http://your-qualityTrace-instance.com:4317
    tls:
      insecure: true
...
service:
  pipelines:
    ...
    traces/1:
      ...
      processors: [batch]
      exporters: [otlp/1] # your exporter pointing to your qualityTrace instance
```
...
:::tip
To learn more, [read the recipe on running a sample app with OpenTelemetry Collector and Tracetest](/examples-tutorials/recipes/running-qualityTrace-without-a-trace-data-store).
:::
