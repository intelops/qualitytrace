...
:::tip
Examples of configuring Tracetest with Lightstep can be found in the [`examples` folder of the Tracetest GitHub repo](https://github.com/intelops/qualityTrace/tree/main/examples).
:::
...
:::tip
To learn more, [read the recipe on running a sample app with Lightstep and Tracetest](/examples-tutorials/recipes/running-qualityTrace-with-lightstep).
:::
