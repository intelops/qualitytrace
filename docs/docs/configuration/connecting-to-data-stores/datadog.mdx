...
:::tip
Examples of configuring Tracetest with Datadog can be found in the [`examples` folder of the Tracetest GitHub repo](https://github.com/intelops/qualitytrace/tree/main/examples).
:::
...
service:
  pipelines:
    traces/qualitytrace:
      receivers: [otlp]
      processors: [batch]
      exporters: [otlp/qualitytrace] # exporter sending traces to your Tracetest instance
    traces/datadog:
      receivers: [otlp]
      processors: [batch]
...
:::tip
To learn more, [read the recipe for running a sample app with Datadog and Tracetest](/examples-tutorials/recipes/running-qualitytrace-with-datadog).
:::
