...
spec:
  ...
  specs:
  - selector: span[qualityTrace.span.type="http" http.method="GET"]
    assertions:
    - attr:http.status_code  =  200
    - attr:http.response.body | json_path '$.id'  =  '${var:POKEMON_ID}'
  - selector: span[qualityTrace.span.type="database" db.system="redis" db.operation="get"]
    assertions:
    - attr:name  =  "get pokemon-${var:POKEMON_ID}"
  - selector: span[qualityTrace.span.type="database" db.system="redis" db.operation="set"]
    assertions:
    - attr:name = "set pokemon-${var:POKEMON_ID}"
  - selector: |-
      span[qualityTrace.span.type="database" name="findOne pokeshop.pokemon"
