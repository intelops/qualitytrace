...
spec:
  ...
  specs:
  - selector: span[qualityTrace.span.type="http" name="GET /pokemon?take=20&skip=0" http.method="GET"]
    assertions:
    - attr:http.status_code = 200
  - selector: span[qualityTrace.span.type="database"]
    assertions:
    - attr:qualityTrace.span.duration   <=   200ms
  - selector: span[qualityTrace.span.type="database" name="pg.query:SELECT pokeshop"
