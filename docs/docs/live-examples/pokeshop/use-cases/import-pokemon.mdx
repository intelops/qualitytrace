...
spec:
  ...
  trigger:
    ...
    httpRequest:
      ...
      body: '{"id":52}'
  specs:
  - selector: span[qualitytrace.span.type="messaging" name="queue.synchronizePokemon
  ...
  - selector: span[qualitytrace.span.type="http" name="HTTP GET pokeapi.pokemon" http.method="GET"]
    assertions:
