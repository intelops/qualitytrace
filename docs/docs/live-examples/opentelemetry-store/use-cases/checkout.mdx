...
spec:
  ...
  - selector: span[qualitytrace.span.type="rpc" name="hipstershop.PaymentService/Charge"
  ...
  - selector: span[qualitytrace.span.type="rpc" name="hipstershop.ShippingService/ShipOrder"
